    ...
    >
      ...
      >
        ...
        <p class="block max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
          Discover a world of endless possibilities with our wide range of
          products, from fashion to home décor.Find the perfect gift for your
          loved ones with our thoughtful selection of products. Stay on top of
          your game with our collection of on-trend and timeless fashion
          pieces.Shop with confidence knowing that all our products are
        ...
        <div class="mt-6 sm:-mx-2">
          <a
            href="#"
            class="inline-flex items-center justify-center w-full px-4 text-sm py-2.5 overflow-hidden text-white transition-colors duration-300 bg-gray-900 rounded-lg shadow sm:w-auto sm:mx-2 hover:bg-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 focus:ring focus:ring-gray-300 focus:ring-opacity-80"
          >
            <svg
              class="w-5 h-5 mx-2 fill-current"
