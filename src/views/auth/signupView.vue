<template>
  <div
    class="flex w-full max-w-sm overflow-hidden container px-6 my-12 border mx-auto bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl"
  >
    <div
    ...
    >
      ...
      <div class="mt-4">
        <label
          class="block mb-2 text-sm text-left font-medium text-gray-600 dark:text-gray-200"
          for="email"
          >Email Address</label
        >
        <input
      ...
      <div class="mt-4">
        <label
          class="block mb-2 text-left text-sm font-medium text-gray-600 dark:text-gray-200"
          for="password"
          >Password</label
        >
